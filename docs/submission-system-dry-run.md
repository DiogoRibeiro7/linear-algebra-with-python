...
- Branch name: `4025001-A01`
- PR title: `Submission 4025001 --- A01`
- Changed path: `assignments/submissions/4025001/01/README.md` (plus `reflexao.md` and `python/main.py`)
- Expected label: `submitted`
- Expected workflow outcome: pass

## Scenario 2: Invalid branch name

- Branch name: `4025001_A01`
- PR title: `Submission 4025001 --- A01`
- Changed path: `assignments/submissions/4025001/01/python/main.py`
...
- Branch name: `4025001-A02`
- PR title: `Submission 4025001 --- A02`
...
- Branch name: `4025002-A03`
- PR title: `Submission 4025002 --- A03`
- Changed path: `assignments/submissions/4025002/03/python/main.py` and `assignments/submissions/4025002/03/javascript/main.js`
- Expected label: `invalid`
- Expected workflow outcome: fail (`exactly one language track` validation)

## Scenario 6: Missing `reflexao.md`

- Branch name: `4025002-A04`
- PR title: `Submission 4025002 --- A04`
- Changed path: `assignments/submissions/4025002/04/README.md` and `assignments/submissions/4025002/04/python/main.py`
- Expected label: `invalid`
- Expected workflow outcome: fail (`required file reflexao.md missing`)

## Scenario 7: Late submission

- Branch name: `4025003-A05`
- PR title: `Submission 4025003 --- A05`
- Changed path: `assignments/submissions/4025003/05/javascript/main.js` (plus required files)
...
- Branch name: `4025123-A06`
- PR title: `Submission 4025123 --- A06`
- Changed path: `assignments/submissions/4025123/06/python/main.py` (plus required files)
...
- Branch name: `4025345-A07`
- PR title: `Submission 4025345 --- A07`
- Changed path: `assignments/submissions/4025345/07/python/main.py`
- Expected label: `invalid`
