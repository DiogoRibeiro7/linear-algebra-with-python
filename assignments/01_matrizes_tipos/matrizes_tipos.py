...
from linalg_utils.matrices import classificar_matriz  # noqa: E402
...
def main() -> None:
    ...
    upper_triangular = np.array([[3, 2, 1], [0, -1, 4], [0, 0, 5]], dtype=float)
    lower_triangular = np.array([[3, 0, 0], [2, -1, 0], [1, 4, 5]], dtype=float)
    M = np.array([[1, 2, 3], [0, -1, 4], [5, 2, 0]], dtype=float)
